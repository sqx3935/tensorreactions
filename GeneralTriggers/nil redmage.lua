...
return false";
 ...
 if xivopeners_rdm ~= nil and xivopeners_rdm.openerStarted == true then return false end\
\
-- checks to see if sally red mage is installed and if its opener is running\
if SallyRDM ~= nil and SallyRDM.SkillSettings.Opener.enabled == true then return false end\
\
-- if no opener is running then return true that it is safe to execute.\
return true";
				["conditionType"] = 1;
				["contentid"] = -1;
				["enmityValue"] = 0;
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "8c468b81-978c-4b22-bfb5-49adadcb0dda";
	};
	[3] = {
		["actions"] = {
			[1] = {
...
return true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "c29f9b54-aaf4-948a-8e6e-96484b6dab4f";
	};
	[4] = {
		["actions"] = {
			[1] = {
...
return true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "9403f04b-faf6-279b-ac2b-5fa7a3224682";
	};
	[5] = {
		["actions"] = {
			[1] = {
		...
		["conditions"] = {
			[1] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "-- checks to see if sally dancer is installed and if its opener is running\
if SallyRDM ~= nil and SallyRDM.SkillSettings.Opener.enabled == true then return false end\
\
...
return true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "c430e705-7fc7-2d14-a326-3124cb5ce603";
	};
	[6] = {
		["actions"] = {
		};
	...
	[7] = {
		...
		["enabled"] = true;
		["eventType"] = 3;
		["execute"] = "if Player.job ~= 35 or Player.alive or Player.level < 32 or (xivopeners_war ~= nil and xivopeners_war.openerStarted == true) or (SallyWAR ~= nil and SallyWAR.SkillSettings.Opener.enabled == true) or (Goliath ~= nil and Goliath_Toggle(1, 2) == true) then\
