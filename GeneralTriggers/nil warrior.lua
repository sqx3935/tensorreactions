...
";
	...
	[3] = {
		...
		["enabled"] = true;
		["eventType"] = 3;
		["execute"] = "if Player.job ~= 21 or Player.alive or Player.level < 32 or (xivopeners_war ~= nil and xivopeners_war.openerStarted == true) or (SallyWAR ~= nil and SallyWAR.SkillSettings.Opener.enabled == true) or (Goliath ~= nil and Goliath_Toggle(1, 2) == true) then\
...
";
	...
	[4] = {
		...
		["enabled"] = true;
		["eventType"] = 3;
		["execute"] = "if Player.job ~= 21 or Player.alive or (xivopeners_war ~= nil and xivopeners_war.openerStarted == true) or (SallyWAR ~= nil and SallyWAR.SkillSettings.Opener.enabled == true)  or (Goliath ~= nil and Goliath_Toggle(1, 2) == true)  then\
		self.eventConditionMismatch = true -- suppressing the log\
		self.used = true \
		return nil\
end\
...
";
	...
	[5] = {
		...
		["enabled"] = true;
		["eventType"] = 3;
		["execute"] = "if Player.job ~= 21 or Player.level < 18 or Player.alive or (xivopeners_war ~= nil and xivopeners_war.openerStarted == true) or (SallyWAR ~= nil and SallyWAR.SkillSettings.Opener.enabled == true) or (Goliath ~= nil and Goliath_Toggle(1, 2) == true)  then\
		self.eventConditionMismatch = true -- suppressing the log\
		self.used = true \
		return nil\
end\
...
return nil";
	...
	[6] = {
		...
		["enabled"] = true;
		["eventType"] = 1;
		["execute"] = "if Player.job ~= 21 or Player.level < 58 or Player.alive or (xivopeners_war ~= nil and xivopeners_war.openerStarted == true) or (SallyWAR ~= nil and SallyWAR.SkillSettings.Opener.enabled == true) or (Goliath ~= nil and Goliath_Toggle(1, 2) == true)  then\
		self.eventConditionMismatch = true -- suppressing the log\
		self.used = true \
		return nil\
end\
...
if hasRegen and Player.hp.percent < 30 then\
		-- if sally installed, use hotbar, otherwise use base\
		if SallyWAR ~= nil then SallyWAR.HotBarConfig.Equilibrium.enabled = false else	actionskill:Cast(Player.id) end \
\
		self.eventConditionMismatch = true -- suppressing the log\
		self.used = true \
		return nil\
...
";
	...
	[7] = {
		...
		["enabled"] = true;
		["eventType"] = 1;
		["execute"] = "if Player.job ~= 21 or Player.level < 56 or Player.alive or (xivopeners_war ~= nil and xivopeners_war.openerStarted == true) or (SallyWAR ~= nil and SallyWAR.SkillSettings.Opener.enabled == true) or (Goliath ~= nil and Goliath_Toggle(1, 2) == true)  then\
		self.eventConditionMismatch = true -- suppressing the log\
		self.used = true \
		return nil\
end\
