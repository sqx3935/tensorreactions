...
";
	...
	[5] = {
		...
		["enabled"] = true;
		["eventType"] = 3;
		["execute"] = "if Player.job ~= 20 or (xivopeners_mnk ~= nil and xivopeners_mnk.openerStarted == true) then\
...
";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "037c2145-f74a-1b81-931a-36bc4cb4b241";
	};
	[10] = {
		["actions"] = {
		};
...
\
if Player.job ~= 22 or (xivopeners_mnk ~= nil and xivopeners_mnk.openerStarted == true) then\
		self.eventConditionMismatch = true -- suppressing the log\
		self.used = true \
		return nil\
end\
