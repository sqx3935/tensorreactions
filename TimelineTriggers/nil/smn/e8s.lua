...
if NilsReactionLibrary.Combat.Toggles.Summoner.CD(false, true) == true then\
  self.used = true\
			...
			["timerStartOffset"] = -15;
			["used"] = false;
			["uuid"] = "aeefb2b5-d43c-f1cb-9efa-6758402bda6b";
		};
		[2] = {
			["actions"] = {
			};
...
if NilsReactionLibrary.Combat.Toggles.Summoner.Pet(false, true) == true then\
  self.used = true\
			...
			["timerStartOffset"] = -15;
			["used"] = false;
			["uuid"] = "12c35f93-a8a8-55e4-9ee8-6c75185e8ed9";
		};
		[3] = {
			["actions"] = {
			};
...
if NilsReactionLibrary.Combat.Toggles.Summoner.Demi(false, true) == true then\
  self.used = true\
			...
			["timerStartOffset"] = -15;
			["used"] = false;
			["uuid"] = "f72804ba-0074-92cb-b07d-d6778ac3c116";
		};
	};
	[36] = {
		[1] = {
...
if wasSuccessful == true then\
  ...
  self.used = true\
			...
			["timerStartOffset"] = -5;
			["used"] = false;
			["uuid"] = "6d6710fa-7d3c-8182-90e0-5cce81eb11e5";
		};
	};
	[110] = {
	};
