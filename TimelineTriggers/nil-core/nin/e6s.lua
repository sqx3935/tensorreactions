...
self.used = table.size(drawnOrbs) >= 7",
			...
			["timerStartOffset"] = -1,
			["used"] = false,
			["uuid"] = "51d4a943-e5ff-34cf-b2af-5cb624cb58d0",
		},
		[2] = {
			["actions"] = {
			},
...
\
-- NE\
Argus.addTimedCircleFilled(11000, 116, 91, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
Argus.addTimedCircleFilled(11000, 111, 90, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
Argus.addTimedCircleFilled(11000, 111, 88, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
\
-- NW\
Argus.addTimedCircleFilled(11000, 90, 90, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
Argus.addTimedCircleFilled(11000, 88, 87, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
\
-- SE\
Argus.addTimedCircleFilled(11000, 111, 114, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
Argus.addTimedCircleFilled(11000, 114, 111, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
Argus.addTimedCircleFilled(11000, 108, 115, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
\
\
-- SW\
Argus.addTimedCircleFilled(11000, 90, 115, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5) -- 4\
Argus.addTimedCircleFilled(11000, 87, 113, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5) -- 4\
Argus.addTimedCircleFilled(11000, 85, 111, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5) -- 4\
Argus.addTimedCircleFilled(11000, 85, 113, 3, 3, 30, {r = 0, g = 1, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5) -- 4\
\
self.used = true",
			["executeType"] = 2,
			["lastUse"] = 0,
			...
			["timerStartOffset"] = 0,
			["used"] = false,
			["uuid"] = "3416fee1-1f93-5520-87db-7de9d833834e",
		},
	},
	[12] = {
		[1] = {
...
self.used = table.size(drawnOrbs) >= 7",
			...
			["timerStartOffset"] = -1,
			["used"] = false,
			["uuid"] = "83e64647-a392-815b-81d4-e06d755cd4fb",
		},
	},
	[49] = {
		[1] = {
