...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = -4;
			["used"] = false;
			["uuid"] = "408dc5b6-f92c-68aa-b5fc-5281e863fba5";
		};
	};
	[23] = {
		[1] = {
...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = -4;
			["used"] = false;
			["uuid"] = "7285605d-b791-236b-a750-84325e06d810";
		};
	};
	[55] = {
		[1] = {
...
";
			...
			["timerStartOffset"] = -3;
			["used"] = false;
			["uuid"] = "37b07c1b-c287-9bf0-b808-51397e308ff5";
		};
		[2] = {
			["actions"] = {
			};
...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = 1;
			["used"] = false;
			["uuid"] = "eb590b9c-db7c-968e-951e-15d2e4033b63";
		};
	};
	[58] = {
		[1] = {
...
";
			...
			["timerStartOffset"] = -1;
			["used"] = false;
			["uuid"] = "d4e96e5f-062c-7e49-9f77-1122841942c6";
		};
		[4] = {
			["actions"] = {
				[1] = {
...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = -4;
			["used"] = false;
			["uuid"] = "bf9a283c-3280-9f2e-87a4-a20070ecde7d";
		};
		[2] = {
			["actions"] = {
				[1] = {
...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = -4;
			["used"] = false;
			["uuid"] = "f9f9c895-8b99-9769-800a-898f2d721505";
		};
	};
	[79] = {
		[1] = {
...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = -4;
			["used"] = false;
			["uuid"] = "571842bc-40df-a4c5-a58c-bf8b99e5dfcc";
		};
	};
	[114] = {
		[1] = {
...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = -4;
			["used"] = false;
			["uuid"] = "8d0b1639-9eba-92fd-871f-495791a79aac";
		};
		[2] = {
			["actions"] = {
			};
...
if wasSuccessful == true then\
  ...
  return action, targetID, ignoreWeaveRules, allowInterrupt\
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "bcf371b2-3096-56db-b612-e393bce8067a";
		};
	};
	[115] = {
		[1] = {
